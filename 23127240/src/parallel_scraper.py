...
class ParallelArxivScraper:
    ...
    def save_metrics(self):
        ...
        # NOTE: Paper details CSV is now generated by main.py with proper format
        # (includes title, authors, processed_at timestamp, etc.)
        # Do not generate it here to avoid conflicts
